#!/usr/bin/env python3
"""Generate artifact-ready RQ2 ablation outputs from sampler performance data."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Generate RQ2 ablation markdown and machine-readable summaries."
    )
    parser.add_argument(
        "--input-parquet",
        type=Path,
...
def write_outputs(args: argparse.Namespace) -> None:
    ...
    md_path = args.output_dir / "rq2_ablation_results.md"
    csv_path = args.output_dir / "rq2_ablation_summary.csv"
    json_path = args.output_dir / "rq2_ablation_summary.json"
