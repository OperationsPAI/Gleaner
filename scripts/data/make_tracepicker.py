...
@timeit()
def run(
    src_folder: str = "data/tracepicker",
    dataset_name: str = "tracepicker",
    exclude_datapack: list[str] | None = None,
):
    ...
    loader._datapack_loaders = [
        datapack for datapack in loader._datapack_loaders if datapack.name not in excluded
    ]
